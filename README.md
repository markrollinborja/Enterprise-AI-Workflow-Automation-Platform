...
- React + TypeScript + Vite + Tailwind CSS frontend with a working login flow, an approval inbox, an employee directory table, and (Administrator-only) Overview / Workflows / Failed Workflows / Workflow Detail (with per-step manual Retry) / Audit Log dashboard pages
